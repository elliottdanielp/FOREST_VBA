...
Public Class ApplyScope
    ...
    Private Sub ApplyScope_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        'SalesHandoff.Scope1.Text = Scope.Text
        'SalesHandoff.UnitID1.Text = UnitID.Text
        'SalesHandoff.Show()
        'Me.Close()
        ...
        SQLLine = "INSERT INTO unit_master (UnitID, JobNumber, Scope, UnitNote, ModelNumber) values (@UnitID, @JobNumber, @Scope, @UnitNote, @ModelNumber);"
        ...
        Using cn As New MySqlConnection("server=192.168.1.122;" & "user id=delliott;" & "password=juice16#cliP;" & "database=forest;"),
            ...
            cmd.Parameters.Add("@UnitNote", MySqlDbType.MediumText).Value = UnitNote.Text
        ...
        SalesHandoff.UnitInfo.Rows.Add()
        Row = SalesHandoff.UnitInfo.Rows.Count - 2

        SalesHandoff.UnitInfo("UnitID", Row).Value = UnitID.Text
        SalesHandoff.UnitInfo("Scope", Row).Value = Scope.Text
        SalesHandoff.UnitInfo("UnitNote", Row).Value = UnitNote.Text
        SalesHandoff.UnitInfo("JobNumber", Row).Value = JobNumber.Text
        SalesHandoff.UnitInfo("ModelNumber", Row).Value = ModelNumber.Text
        SalesHandoff.UnitInfo.Refresh()
        SalesHandoff.Show()
        Me.Close()
    ...
    Private Sub ApplyScope_Load(sender As Object, e As EventArgs) Handles Me.Load

        JobNumber.Text = SalesHandoff.JobNumber1.Text
        'UnitID.Text = SalesHandoff.JobNumber1.Text + "F-"

    End Sub

    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles TextBox2.TextChanged

        UnitID.Text = JobNumber.Text + "F" + "-" + TextBox2.Text
